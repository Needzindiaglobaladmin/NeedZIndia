...
class PanCard extends StatefulWidget {
  @override
  _PanCard createState() => _PanCard();
}

class _PanCard extends State<PanCard> {
  bool _loading = true;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: FittedBox(fit:BoxFit.fitWidth,
          child: Text('Pan Card',style: GoogleFonts.quicksand(
            ...
            child: Column(
              children: <Widget>[
                    ...
                    child: Carousel(
                      ...
                      images: [
                        ProgressiveImage(
                          ...
                          // size: 1.87KB
                          thumbnail: NetworkImage('https://www.needzindia.com/Carousels_images/Pancard.jpg'),
                          // size: 1.29MB
                          image: NetworkImage('https://www.needzindia.com/Carousels_images/Pancard.jpg'),
                          height: 300,
                          width: 500,
                        ),
                      ],
                ...
                Container(
                  ...
                  child: FittedBox(
                    fit: BoxFit.fitWidth,
                    child: Text('Welcome to NeedZ India\'s PAN Service',style: GoogleFonts.quicksand(
                      textStyle: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),),),
                  )
                ),
                Text('We made it easier for you just handover the documents to our executive and get your PAN delivered to your home within 30 days.',style: GoogleFonts.quicksand(
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(10, 10, 0, 10),
                  alignment: Alignment.centerLeft,
                  child: Text('Note - Required documents are xerox of Aadhaar Card and two copy passport size photo',style: GoogleFonts.quicksand(
                ...
                Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text('Choose Slot',style: GoogleFonts.quicksand(
                      textStyle: TextStyle(fontSize: 18),),),
                    onPressed: ()  {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> BookingSlots(servicesData: servicesData,serviceName:'Pan Card')),
                      );
                      }
                  ),
                ),
